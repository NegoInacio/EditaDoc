# LicitaDoc — documento de referência do projeto
...
└── LICITADOC_REFERENCE.md      # Este arquivo
```
...
JWT_SECRET=
ANTHROPIC_API_KEY=
CLOUDFLARE_R2_BUCKET=licitadoc-files
...
# Frontend
VITE_API_URL=https://api.licitadoc.com.br
```
